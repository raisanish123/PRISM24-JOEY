...
#try to get max unique one and set n classes to that value
...
# plot history
pyplot.plot(model.history['accuracy'], label='train_accuracy')
pyplot.plot(model.history['val_accuracy'], label='test_accuracy')
pyplot.legend()
pyplot.show()
"""
